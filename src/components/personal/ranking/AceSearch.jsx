...
class AceSearch extends Component {
	render() {

		return (
			<ul className="ace-list">
				<li>
					<div className="header">
						<div className="user">
							<img src="https://ss2.baidu.com/6ONYsjip0QIZ8tyhnq/it/u=2222457038,1434704351&fm=58" />
							<span>奥利维亚</span>
						</div>
						<a className="attention-btn">关注</a>
					</div>
					<div className="ace-list-item">
						...
						<div className="data-msg">
							<div className="data--msg-item">
								...
								<p className="data-num3">27.89%</p>
							</div>
							<div className="data--msg-item">
								<p className="label">交易笔数</p>
								<p className="data-num3">27笔</p>
							</div>
						</div>
					</div>
				</li>

...
export default class MyLevel extends Component {
    ...
    render() {
        ...
        const imgArr = [
            require('static/images/level_one_small.png'),
            require('static/images/level_two_small.png'),
            require('static/images/level_three_small.png'),
            require('static/images/level_four_small.png')
        ]
            ...
            <div className="my-level">
                <div className="level-steps">
                    <div className={data.myLevel == 1 ? "level-step current-step" : "level-step"}>
                        <img src={require('static/images/level_one_small.png')} />
                        <p>等级1</p>
                    </div>
                    <div className={data.myLevel == 2 ? "level-step current-step" : "level-step"}>
                        <img src={require('static/images/level_two_small.png')} />
                        <p>等级2</p>
                    </div>
                    <div className={data.myLevel == 3 ? "level-step current-step" : "level-step"}>
                        <img src={require('static/images/level_three_small.png')} />
                        <p>等级3</p>
                    </div>
                    <div className={data.myLevel == 4 ? "level-step current-step" : "level-step"}>
                        <img src={require('static/images/level_four_small.png')} />
                        <p>等级4</p>
                    </div>
                </div>
